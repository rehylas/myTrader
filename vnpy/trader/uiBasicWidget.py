...
class BasicMonitor(QtWidgets.QTableWidget):
    ...
    def addSymbol(self):
        ...
        #('sendOrder:', u'SHFE', 'ru1901', u'ru1901.SHFE', u'CTP')    
    ...
    def initMenu(self):
        ...
        addSymbolAction = QtWidgets.QAction(vtText.ADD_SYMBOL, self)
        addSymbolAction.triggered.connect(self.addSymbol)

        self.menu.addAction(resizeAction)
        self.menu.addAction(saveAction)
        self.menu.addAction(addSymbolAction)
...
class TradingWidget(QtWidgets.QFrame):
    ...
    def initUi(self):
        ...
        buttonAddSymbol = QtWidgets.QPushButton(vtText.ADD_SYMBOL)
        ...
        buttonAddSymbol.setMinimumHeight(size.height()*2)
        ...
        vbox.addWidget(buttonAddSymbol)
        ...
        buttonAddSymbol.clicked.connect(self.addSymbol)
