...
class N5Algo(AlgoTemplate):
    ...
    templateName = u'N5 止损'

    #----------------------------------------------------------------------
    def __init__(self, engine, setting, algoName):
        """Constructor"""
        super(N5Algo, self).__init__(engine, setting, algoName)
    ...
    def onTick(self, tick):
        ...
        7.14:58 自动平仓
        """  
        contract = self.engine.getContract( N5Algo, self.vtSymbol ) #,'SHFE' 
        # print('contract :' ) 
...
########################################################################
class N5Widget(AlgoWidget):
    """"""
    
    #----------------------------------------------------------------------
    def __init__(self, algoEngine, parent=None):
        """Constructor"""
        super(N5Widget, self).__init__(algoEngine, parent)
        
        self.templateName = N5Algo.templateName
    ...
    def getAlgoSetting(self):
        """"""
        setting = OrderedDict()
        setting['templateName'] = N5Algo.templateName
