...
class DuiduAlgo(AlgoTemplate):
    ...
    def __init__(self, engine, setting, algoName):
        """Constructor"""
        super(DuiduAlgo, self).__init__(engine, setting, algoName)
        ...
        self.expectWin = -float(setting['maxFail'])          # 短期预期盈利  
    ...
    def onTick(self, tick):
        ...
        7.14:58 自动平仓
        """  
        contract = self.engine.getContract( DuiduAlgo, self.vtSymbol ) #,'SHFE' 
        # print('contract :' ) 
...
########################################################################
class DuiduWidget(AlgoWidget):
    """"""
    
    #----------------------------------------------------------------------
    def __init__(self, algoEngine, parent=None):
        """Constructor"""
        super(DuiduWidget, self).__init__(algoEngine, parent)
        
        self.templateName = DuiduAlgo.templateName
    ...
    def initAlgoLayout(self):
        ...
        self.spinMaxfail.setValue(-25.0)
    ...
    def getAlgoSetting(self):
        """"""
        setting = OrderedDict()
        setting['templateName'] = DuiduAlgo.templateName
        ...
        setting['expectWin'] = -float(self.spinMaxfail.value()) #float(self.spinExpectWin.value())
