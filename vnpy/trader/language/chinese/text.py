...
DATABASE_CONNECTING_COMPLETED_REDIS = u'Redis 连接成功'
DATABASE_CONNECTING_FAILED_REDIS = u'Redis 连接失败'
DATA_GET_FAILED_REDIS = u'数据查询失败，Redis 没有连接'
DATA_SET_FAILED_REDIS = u'数据查询失败，Redis 没有连接'
DATA_ERROR_REDIS = u'Redis 错误'